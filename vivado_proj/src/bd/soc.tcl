...
proc create_hier_cell_axi_eth_dma { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 eth_clk
  ...
  connect_bd_intf_net -intf_net CLK_IN1_D_0_1 [get_bd_intf_pins eth_clk] [get_bd_intf_pins axi_ethernet_0_refclk/CLK_IN1_D]
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CLK_IN1_D_0_1 [get_bd_intf_ports sys_clk] [get_bd_intf_pins axi_eth_dma/eth_clk]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_ps_M02_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins axi_interconnect_ps/M02_AXI]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins xlconcat_0/In5]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_eth_dma/s_axi_lite_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_interconnect_ps/M00_ARESETN] [get_bd_pins axi_interconnect_ps/M01_ARESETN] [get_bd_pins axi_interconnect_ps/M02_ARESETN] [get_bd_pins axi_interconnect_ps/S00_ARESETN] [get_bd_pins axi_interconnect_rocket_mmio/M00_ARESETN] [get_bd_pins axi_interconnect_rocket_mmio/M01_ARESETN] [get_bd_pins axi_interconnect_rocket_mmio/M02_ARESETN] [get_bd_pins axi_interconnect_rocket_mmio/S00_ARESETN] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x60140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces S_MMIO_AXI] [get_bd_addr_segs axi_eth_dma/axi_ethernet_0/s_axi/Reg0] -force
